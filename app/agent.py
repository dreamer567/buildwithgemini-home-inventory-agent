...
- 【中卧·起居主卧 (Master Bedroom)】：1.8米实木双人床（床头悬空几放中卧空调与顶灯遥控器、温湿度计）、经典和式大容量押入壁橱 (Oshiire - 上层天袋收纳28寸/20寸空行李箱与五金工具螺丝盒；中层挂衣区内壁配置阻尼抽拉旋转全身镜[120×35cm，拉开移门顺滑抽出旋转90°照镜，推回完全隐形0占地，彻底解决和式移门不能贴镜与主卧无镜痛点，避开对床反光]与避光隔板放置专用家庭医药箱[布洛芬、创口贴、碘伏]；下层三组深抽屉塑料箱分类收纳全家换季被套衣物；主卧角落同时兼容360°旋转衣帽全身镜收纳次净睡衣）。
- 【西卧·儿童房与战略储物间 (West Bedroom - Kids & Storage Hub)】：儿童成长床与分类矮柜；封闭式四门大衣柜（平开双门内侧贴120×30cm超薄防爆全身镜，开门试衣照镜，关门彻底隐形，儿童房完全防撞防碎；最上层收纳闲置备用落地扇与客用加厚羽绒被；最下层为全家大宗物资备货战略区，囤放整箱未拆原木抽纸、大容量洗衣液补充装、大桶洗洁精、5kg五常大米）。
