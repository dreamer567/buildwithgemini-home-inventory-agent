...
One-liner: A conversational agent that helps a family of three manage household assets, grocery freshness, and shopping replenishment with a catalog of 3LDK home items and pantry stock.

Tool coverage:
- Memory: User's 3LDK layout (east-facing study with 1m desk, master bedroom with oshiire closet, west room for kids and bulk storage, east-facing living room with AC/projector/dining table), family habits (placing scissors at entrance and desk, remote controls inside oshiire edge to eliminate bedside chairs, personal seal on entrance shoe cabinet), consumption habits, and dietary preferences.
- Tools: Inventory lookups and management (search_item, add_item, update_item), scientific food/asset preservation advice (get_storage_advice), expiry & stock shortage audit (check_inventory_alerts), and automated family replenishment plan generation (generate_shopping_plan).
...
First eval question: "我后天要去超市采购，帮我检查一下冰箱和储物间，生成一份紧急程度明确的家庭生活采购计划，并提醒我哪些食材必须先吃完。"
